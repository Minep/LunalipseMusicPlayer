...
namespace NewMediaPlayer.PluginHoster
{
    public class UIDrawable
    {
        ...
        public void DrawButton(object target, LButton lb, LunalipseTarget lt)
        {
            Button b = new Button
            {
                Name = lb.Name,
        ...
        public void DrawLabel(object target, LLabel lb, LunalipseTarget lt)
        {
            Label b = new Label
            {
                Name = lb.Name,
        ...
        public void DrawVanilla(object target,LunalipseTarget lt,Control c)
        {
            AddTo(target, lt, c);
        }
